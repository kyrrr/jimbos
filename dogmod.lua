...
local config = {
  -- Decks
  evenStevenDeck = false, --true,
  oddToddDeck = false, --true,
  fibonacciDeck = false ,--true,
  primeDeck = false, --true, -- Do not enable without primeTimeJoker
  midasDeck = false, --true,
  jokersForHireDeck = false, --true,
  dogDeck = true,
